...
const { createTaskValidation, listTasksValidation, reorderTasksValidation, taskIdValidation, updateTaskValidation, } = require("../../validations/task.validation.js");
...
app.put("/reorder", validator(reorderTasksValidation), errorHandler(taskController.reorder));
app.patch("/reorder", validator(reorderTasksValidation), errorHandler(taskController.reorder));
